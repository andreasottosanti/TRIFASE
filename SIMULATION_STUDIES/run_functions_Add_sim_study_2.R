# Run additional simulation study 2 ----
...
dir_path_scenario<-"SIMULATION_STUDIES/SIMULATION_RESULTS/Add_sim_study_2/SCENARIOS/"
dir_path_genData<-"SIMULATION_STUDIES/SIMULATION_RESULTS/Add_sim_study_2/GENERATED_DATA/"
dir_path_estimate<-"SIMULATION_STUDIES/SIMULATION_RESULTS/Add_sim_study_2/ESTIMATE_RUNS/"
dir_path_extracted<-"SIMULATION_STUDIES/SIMULATION_RESULTS/Add_sim_study_2/EXTRACT_RESULTS/"
dir_path_parameters<-"SIMULATION_STUDIES/SIMULATION_RESULTS/Add_sim_study_2/SET_PARAMETERS/"
...
n.parameters<-(length(nclust.pt.start)*length(nclust.prot.start)*length(tau.start)*
  ...
  (length(nclust.pt.start)*length(nclust.prot.start))+ #3 combinations for Wang (est.kernel=none)
  (length(nclust.pt.start)*length(nclust.prot.start))  #3 combinations for k-means (est.kernel=km)
for(int in 1:n.scenari){
